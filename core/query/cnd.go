...
type Cnd struct {
	...
	Pagination  Dialect     // 16字节 - 结构体字段 (假设)
...
func (self *Cnd) Limit(pageNo int64, pageSize int64) *Cnd {
	...
	self.Pagination = Dialect{PageNo: pageNo, PageSize: pageSize, Spilled: true, IsPage: true}
	return self
}
...
func (self *Cnd) Offset(offset int64, limit int64) *Cnd {
	...
	self.Pagination = Dialect{PageNo: offset, PageSize: limit, Spilled: true, IsOffset: true, IsPage: true}
	return self
}
...
func (self *Cnd) FastPage(fast *FastObject) *Cnd {
	...
	self.Pagination = Dialect{PageNo: 0, PageSize: pageSize, IsFastPage: true, FastPageKey: fast.key, FastPageSort: fast.sort, FastPageParam: []int64{fast.PrevID, fast.LastID}, FastPageSortCountQ: fast.CountQ}
	return self
}
...
func (self *Cnd) GetPageResult() PageResult {
