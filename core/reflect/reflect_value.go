...
func NewInt(b []byte) (int, error) {
	...
	if i, err := strconv.ParseInt(utils.Bytes2Str(b), 10, strconv.IntSize); err != nil {
		return 0, err
	} else {
		return int(i), nil
	}
...
func NewInt8(b []byte) (int8, error) {
	...
	i, err := strconv.ParseInt(utils.Bytes2Str(b), 10, 8)
	if err != nil {
		return 0, err
	}
	return int8(i), nil
...
func NewInt16(b []byte) (int16, error) {
	...
	if i, err := strconv.ParseInt(utils.Bytes2Str(b), 10, 16); err != nil {
		return 0, err
	} else {
		return int16(i), nil
	}
...
func NewInt32(b []byte) (int32, error) {
	...
	if i, err := strconv.ParseInt(utils.Bytes2Str(b), 10, 32); err != nil {
		return 0, err
	} else {
		return int32(i), nil
	}
...
func NewInt64(b []byte) (int64, error) {
	...
	if i64, err := strconv.ParseInt(utils.Bytes2Str(b), 10, 64); err != nil {
		return 0, err
	} else {
		return i64, nil
	}
...
func NewFloat32(b []byte) (float32, error) {
	...
	f32, err := strconv.ParseFloat(utils.Bytes2Str(b), 32)
	if err != nil {
		return 0, err
	}
...
func NewFloat64(b []byte) (float64, error) {
	...
	f64, err := strconv.ParseFloat(utils.Bytes2Str(b), 64)
	if err != nil {
		return 0, err
	}
	return f64, nil
...
func NewUint(b []byte) (uint, error) {
	...
	if u, err := strconv.ParseUint(utils.Bytes2Str(b), 10, strconv.IntSize); err != nil {
		return 0, err
	} else {
		return uint(u), nil
	}
...
func NewUint8(b []byte) (uint8, error) {
	...
	if u, err := strconv.ParseUint(utils.Bytes2Str(b), 10, 8); err != nil {
		return 0, err
	} else {
		return uint8(u), nil
	}
...
func NewUint16(b []byte) (uint16, error) {
	...
	if u, err := strconv.ParseUint(utils.Bytes2Str(b), 10, 16); err != nil {
		return 0, err
	} else {
		return uint16(u), nil
	}
...
func NewUint32(b []byte) (uint32, error) {
	...
	if u, err := strconv.ParseUint(utils.Bytes2Str(b), 10, 32); err != nil {
		return 0, err
	} else {
		return uint32(u), nil
	}
...
func NewUint64(b []byte) (uint64, error) {
	...
	if u, err := strconv.ParseUint(utils.Bytes2Str(b), 10, 64); err != nil {
		return 0, err
	} else {
		return u, nil
	}
