...
**语言 / Languages:** [简体中文](README_ZH.md) · [English](README.md) · [繁體中文](README_TW.md)

> 🚀 **专注于极致性能优化、抗量子攻击与强安全取向的 Go 语言企业级框架**（安全架构与实现流程见 [`README_SECURITY_ZH.md`](./README_SECURITY_ZH.md)）
...
- **API 框架**：提供 HTTP / WebSocket / RPCX 接入与过滤器链能力，并提供认证、授权、完整性校验和防重放能力；安全流程与威胁模型见 [`README_SECURITY_ZH.md`](./README_SECURITY_ZH.md)。
...
实现流程与分层防护见 [`README_SECURITY_ZH.md`](./README_SECURITY_ZH.md)。
...
安全架构与 Plan 流程见 [`README_SECURITY_ZH.md`](./README_SECURITY_ZH.md)。
...
- 📖 **安全文档**: [`README_SECURITY_ZH.md`](./README_SECURITY_ZH.md)
