...
func easyjson903aeb83DecodeGithubComGodaddyXFreegoUtils(in *jlexer.Lexer, out *Limit) {
...
func easyjson903aeb83EncodeGithubComGodaddyXFreegoUtils(out *jwriter.Writer, in Limit) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func (v Limit) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson903aeb83EncodeGithubComGodaddyXFreegoUtils(&w, v)
...
func (v *Limit) UnmarshalJSON(data []byte) error {
	...
	easyjson903aeb83DecodeGithubComGodaddyXFreegoUtils(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *Limit) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson903aeb83DecodeGithubComGodaddyXFreegoUtils(l, v)
}
