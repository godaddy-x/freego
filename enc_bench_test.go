...
var (
	encipherClient1 = sdk.NewEncipherClient("http://localhost:4141")
)
...
func BenchmarkEncSignature(b *testing.B) {
	...
	for i := 0; i < b.N; i++ { //use b.N for looping
		_, err := encipherClient1.Signature(msg)
		if err != nil {
			panic(err)
		}
		//fmt.Println(pub)
...
func BenchmarkEncPublicKey(b *testing.B) {
	...
	b.StartTimer()
	for i := 0; i < b.N; i++ { //use b.N for looping
		_, err := encipherClient1.PublicKey()
		if err != nil {
			panic(err)
		}
	}
...
func BenchmarkEncVerify(b *testing.B) {
	...
	b.StartTimer()
	for i := 0; i < b.N; i++ { //use b.N for looping
		_, err := encipherClient1.SignatureVerify(msg, "a0aed385a895109ca3e82d6ba0fcbaecc717fb8ca47ede204409e7428408be377901d5cccc7e8ddf5bf195c39dfaf0e4")
		//fmt.Println(pub)
		if err != nil {
			panic(err)
		}
...
func BenchmarkEncEncrypt(b *testing.B) {
	...
	b.StartTimer()
	for i := 0; i < b.N; i++ { //use b.N for looping
		_, err := encipherClient1.Encrypt(msg)
		if err != nil {
			panic(err)
		}
	}
