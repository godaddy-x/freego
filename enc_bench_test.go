...
func BenchmarkEncAesEncrypt(b *testing.B) {
	b.StopTimer()
	b.StartTimer()
	for i := 0; i < b.N; i++ { //use b.N for looping
		_, err := encipherClient.AesEncrypt(msg)
		if err != nil {
			panic(err)
		}
	}
...
func BenchmarkEncEccDecrypt(b *testing.B) {
	b.StopTimer()
	b.StartTimer()
	for i := 0; i < b.N; i++ { //use b.N for looping
		_, err := encipherClient.AesDecrypt("")
