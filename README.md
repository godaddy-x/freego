...
**Languages:** [简体中文](README_ZH.md) · [English](README.md) · [繁體中文](README_TW.md)

> 🚀 **A Go enterprise framework focused on extreme performance, quantum attack resistance, and strong security** (architecture and flows in [`README_SECURITY.md`](./README_SECURITY.md))
...
- **API framework**: HTTP / WebSocket / RPCX ingress, filter chains, authentication, authorization, integrity verification, and anti-replay (see [`README_SECURITY.md`](./README_SECURITY.md)).
...
Flows and layered defenses: [`README_SECURITY.md`](./README_SECURITY.md).
...
Architecture and Plan flows: [`README_SECURITY.md`](./README_SECURITY.md).
